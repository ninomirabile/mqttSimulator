...
from mqtt_simulator.profiles.agriculture import (
    AgricultureProfile,
    SoilMoistureData,
)
...
class TestAgricultureProfile:
    ...
    def test_agriculture_profile_custom_config(self):
        ...
        profile = AgricultureProfile(
            sensor_id="soil-002", soil_type="sandy", base_moisture=30.0
        )
...
class TestEnergyProfile:
    ...
    def test_energy_profile_custom_config(self):
        ...
        profile = EnergyProfile(
            meter_id="energy-02", load_pattern="industrial", base_power=50.0
        )
